...
<div class="main">
    ...
    <div class="main__form">
        {!! Form::open(['url' => route('update.products',['id'=>$product_update->id]), 'method' => 'post','files' => true]) !!}
        @csrf
            ...
            <div class="form-group">
                {!! Form::label('tensanpham', 'Sản phẩm') !!} <br>
                {!! Form::text('tensanpham',$product_update->tensanpham, ['placeholder' => 'Sản phẩm']) !!}
                @error('name')
                    <small class="form-text text-danger ">
                        {{$message}}
                    </small>
            ...
            <div class="form-group">
                ...
                {!! Form::textarea('dacdiemnoibat',$product_update->dacdiemnoibat, ['placeholder' => 'Đặc điểm nổi bật']) !!}
                @error('name')
                    <small class="form-text text-danger ">
                        {{$message}}
                    </small>
            ...
            <div class="form-group">
                ...
                {!! Form::textarea('thongsokythuat',$product_update->thongsokythuat, ['placeholder' => 'Thông số kỹ thuật']) !!}
                @error('name')
                    <small class="form-text text-danger ">
                        {{$message}}
                    </small>
            ...
            <div class="form-group">
                ...
                {!! Form::text('color',$product_update->color, ['placeholder' => 'Màu']) !!}
                @error('name')
                    <small class="form-text text-danger ">
                        {{$message}}
                    </small>
            ...
            <div class="form-group">
                ...
                {!! Form::text('price',$product_update->price, ['placeholder' => 'Giá']) !!}
                @error('name')
                    <small class="form-text text-danger ">
                        {{$message}}
                    </small>
